...
"""
            ...
            val face = loadFace("data/fonts/NotoSansKR-VariableFont_wght.ttf", 64.0, 1.0)
            ...
            slugMap.addShape(shape)
            slugMap.addShape(face.glyphForCharacter('3').shape())
            slugMap.addShape(face.glyphForCharacter('삼').shape())
            slugMap.addShape(face.glyphForCharacter('±').shape())
            ...
            extend {
                ...
                drawer.vertexBufferInstances(listOf(vb), listOf(instances), DrawPrimitive.TRIANGLES, 4)
