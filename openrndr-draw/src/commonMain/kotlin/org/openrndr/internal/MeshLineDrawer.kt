...
class MeshLineDrawer {
    ...
    fun drawLineSegments(drawContext: DrawContext, drawStyle: DrawStyle, segments: List<Vector3>,
        ...
        Driver.instance.drawVertexBuffer(shader, listOf(vertices), DrawPrimitive.TRIANGLES, 0, vertexCount, verticesPerPatch = 0)
        shader.end()
    }
    ...
    fun drawLineStrips(drawContext: DrawContext,
        ...
        Driver.instance.setState(drawStyle)
        Driver.instance.drawVertexBuffer(shader, listOf(vertices), DrawPrimitive.TRIANGLE_STRIP, 0, vertexCount, verticesPerPatch = 0)
        shader.end()
    }
}