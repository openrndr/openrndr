...
class FaceStbTt(data: ByteBuffer, fontInfo: STBTTFontinfo) : Face {
    ...
    override fun ascent(size: Double): Double {
        stackPush().use {
            ...
            STBTruetype.stbtt_GetFontVMetrics(state.fontInfo, pAscent, null, null)
            return pAscent.get(0) * scaleForSize(size)
        }
    }
    ...
    override fun descent(size: Double): Double {
        stackPush().use {
            ...
            STBTruetype.stbtt_GetFontVMetrics(state.fontInfo, null, pDescent, null)
            return pDescent.get(0) * scaleForSize(size)
        }
    }
    ...
    override fun lineGap(size: Double): Double {
        stackPush().use {
            ...
            STBTruetype.stbtt_GetFontVMetrics(state.fontInfo, null, null, plineGap)
            return plineGap.get(0) * scaleForSize(size)
        }
    }
...
class GlyphStbTt(val face: FaceStbTt, val character: Char, val glyphIndex: Int) : Glyph {
